...
function LoginCard() {
  ...
  return (
    ...
    >
      <h1 className="font-primary-bold text-[2rem] uppercase tracking-wider text-black">Sign Up</h1>
      <LoginForm />
      <button
        className="flex h-[4rem] w-[23rem] items-center justify-center gap-[1rem] rounded-[.2rem] border-[.1rem] border-gray-300 text-[1.1rem] font-bold uppercase text-white shadow-individual-room-card"
