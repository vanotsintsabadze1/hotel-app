...
function IntroductionTextContainer() {
  return (
    <div className="flex w-full flex-grow flex-col items-center uppercase">
      <div className="flex h-[22rem] w-full flex-col items-center justify-center text-white md:h-[30rem] lg:h-[45rem] lg:w-[90rem] lg:items-start xl:w-[120rem]">
        ...
        <h1 className="font-secondary text-[5rem] uppercase tracking-[0.5rem] drop-shadow-hero-text md:text-[8rem] lg:text-[10rem] lg:font-semibold lg:leading-[12rem] lg:tracking-[2rem]">
          Luxury
        </h1>
