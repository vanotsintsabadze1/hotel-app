...
function Footer() {
  return (
    <footer className="flex min-h-[40rem] w-full flex-grow items-center justify-center  bg-secondary lg:min-h-[20rem] lg:flex-row lg:items-start lg:justify-center lg:gap-[10rem] lg:pt-[2rem]">
